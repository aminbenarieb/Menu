...
begin    
  ...
  Writeln(#10, 'Предложение с наибольшем количеством слов палендромов:');
  printSentence(Concat('"',Trim(MaxSentence),'"', #10, #10));
end;
...
begin
  ...
  begin
     ...
     Writeln('    3 - чтобы найти предложение с наибольшем количеством'+#10+
             ' слов палендромов');
